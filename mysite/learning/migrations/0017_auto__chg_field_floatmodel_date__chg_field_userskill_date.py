...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FloatModel.date'
        db.alter_column(u'learning_floatmodel', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'UserSkill.date'
        db.alter_column(u'learning_userskill', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default='2015-03-20 22:57:25'))

    def backwards(self, orm):

        # Changing field 'FloatModel.date'
        db.alter_column(u'learning_floatmodel', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'UserSkill.date'
        db.alter_column(u'learning_userskill', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
