...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConceptQuestion.hint'
        db.add_column(u'learning_conceptquestion', 'hint',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConceptQuestion.hint'
        db.delete_column(u'learning_conceptquestion', 'hint')
