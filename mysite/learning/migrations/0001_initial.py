...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'learning_floatmodel', (
            ...
            ('question', self.gf('django.db.models.fields.FloatField')(null=True)),
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 27, 0, 0), null=True)),
        ))
        ...
        db.create_table(u'learning_concept', (
            ...
            ('param1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.Params'])),
        ...
        db.create_table(u'learning_params', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('param', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
    ...
    models = {
        ...
        u'learning.concept': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'param1': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['learning.Params']"}),
