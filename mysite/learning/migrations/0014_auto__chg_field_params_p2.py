...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Params.p2'
        db.alter_column(u'learning_params', 'p2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Params.p2'
        db.alter_column(u'learning_params', 'p2', self.gf('django.db.models.fields.CharField')(default=-1, max_length=20))
    ...
    models = {
        ...
        u'learning.floatmodel': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 9, 0, 0)', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
