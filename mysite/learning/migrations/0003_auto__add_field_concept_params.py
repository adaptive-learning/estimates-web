...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concept.params'
        db.add_column(u'learning_concept', 'params',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='params', to=orm['learning.Params']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concept.params'
        db.delete_column(u'learning_concept', 'params_id')
