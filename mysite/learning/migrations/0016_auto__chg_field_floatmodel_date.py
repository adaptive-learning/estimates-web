...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'learning_floatmodel', 'date', self.gf('django.db.models.fields.DateTimeField')(default="2015-03-20 10:30:37"))

    def backwards(self, orm):

        # Changing field 'FloatModel.date'
        db.alter_column(u'learning_floatmodel', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'learning.userskill': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 20, 0, 0)', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
