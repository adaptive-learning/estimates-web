...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FloatModel.inTime'
        db.delete_column(u'learning_floatmodel', 'inTime')

        # Adding field 'FloatModel.timer'
        db.add_column(u'learning_floatmodel', 'timer',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


        # Changing field 'FloatModel.time'
        db.alter_column(u'learning_floatmodel', 'time', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Adding field 'FloatModel.inTime'
        db.add_column(u'learning_floatmodel', 'inTime',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'FloatModel.timer'
        db.delete_column(u'learning_floatmodel', 'timer')


        # Changing field 'FloatModel.time'
        db.alter_column(u'learning_floatmodel', 'time', self.gf('django.db.models.fields.IntegerField')())
