...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'learning_userskill', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'FloatModel.date'
        db.alter_column(u'learning_floatmodel', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'UserSkill.date'
        db.alter_column(u'learning_userskill', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
