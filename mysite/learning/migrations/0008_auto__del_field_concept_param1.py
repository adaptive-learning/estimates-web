...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Concept.param1'
        db.delete_column(u'learning_concept', 'param1_id')


    def backwards(self, orm):
        # Adding field 'Concept.param1'
        db.add_column(u'learning_concept', 'param1',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.Params'], null=True),
                      keep_default=False)
