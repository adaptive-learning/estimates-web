...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concept.updatedTimes'
        db.add_column(u'learning_concept', 'updatedTimes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concept.updatedTimes'
        db.delete_column(u'learning_concept', 'updatedTimes')
    ...
    models = {
        ...
        u'learning.floatmodel': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 16, 0, 0)', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
