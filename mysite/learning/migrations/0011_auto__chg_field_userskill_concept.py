...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSkill.concept'
        db.alter_column(u'learning_userskill', 'concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.Params']))

    def backwards(self, orm):

        # Changing field 'UserSkill.concept'
        db.alter_column(u'learning_userskill', 'concept_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.Type']))
