...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Concept.question'
        db.alter_column(u'learning_concept', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learning.Questions'], null=True))

    def backwards(self, orm):

        # Changing field 'Concept.question'
        db.alter_column(u'learning_concept', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['learning.Questions']))
