...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FloatModel.label'
        db.delete_column(u'learning_floatmodel', 'label')

        # Adding field 'FloatModel.relative_error'
        db.add_column(u'learning_floatmodel', 'relative_error',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'ConceptQuestion.label'
        db.delete_column(u'learning_conceptquestion', 'label')

        # Adding field 'ConceptQuestion.difficulty'
        db.add_column(u'learning_conceptquestion', 'difficulty',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FloatModel.label'
        db.add_column(u'learning_floatmodel', 'label',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'FloatModel.relative_error'
        db.delete_column(u'learning_floatmodel', 'relative_error')

        # Adding field 'ConceptQuestion.label'
        db.add_column(u'learning_conceptquestion', 'label',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'ConceptQuestion.difficulty'
        db.delete_column(u'learning_conceptquestion', 'difficulty')
    ...
    models = {
        ...
        u'learning.conceptquestion': {
            ...
            'difficulty': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
        ...
        u'learning.floatmodel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'relative_error': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            ...
            'timer': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['learning.Type']"}),
