...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSkill.number'
        db.add_column(u'learning_userskill', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserSkill.date'
        db.add_column(u'learning_userskill', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSkill.number'
        db.delete_column(u'learning_userskill', 'number')

        # Deleting field 'UserSkill.date'
        db.delete_column(u'learning_userskill', 'date')
